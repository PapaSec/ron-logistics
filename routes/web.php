...
use App\Livewire\Shipments\{Create as ShipmentsCreate, Edit as ShipmentsEdit, Index as ShipmentsIndex, Show as ShipmentsShow, Tracking as ShipmentsTrackingShipments};
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('shipments')->name('shipments.')->group(function () {
        ...
        Route::get('/tracking', ShipmentsTrackingShipments::class)->name('tracking');
    });
