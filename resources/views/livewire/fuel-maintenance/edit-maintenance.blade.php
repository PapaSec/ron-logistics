<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
                <i class="fas fa-edit text-[#138898] mr-2"></i> Edit Maintenance Record
            </h2>
            <p class="text-gray-600 dark:text-gray-400">Update maintenance service details</p>
        </div>

        <x-button style="back" href="{{ route('fuel-maintenance.show-maintenance', $maintenanceRecord->id) }}" icon="fas fa-arrow-left">
            Back to Details
        </x-button>
    </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-500/20 p-4 rounded-lg mb-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Editing Record</p>
                <p class="text-2xl font-bold text-[#138898] mt-1">{{ $maintenance_number }}</p>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    <i class="fas fa-info-circle mr-1"></i>
                    Created {{ $maintenanceRecord->created_at->diffForHumans() }}
                </p>
            </div>
        ...
        <form wire:submit.prevent="update" class="space-y-6">
            ...
            <div class="flex justify-end pt-4 space-x-4">
                ...
                <x-button type="submit" style="submit" icon="fas fa-save" wire:loading.attr="disabled">
                    <span wire:loading.remove wire:target="update">Update Maintenance Record</span>
