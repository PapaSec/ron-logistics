    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
                <i class="fas fa-edit text-[#138898] mr-2"></i> Edit Fuel Record
            </h2>
            <p class="text-gray-600 dark:text-gray-400">Update fuel transaction details</p>
        </div>

        <x-button style="back" href="{{ route('fuel-maintenance.show-fuel', $fuelRecord->id) }}" icon="fas fa-arrow-left">
            Back to Details
        </x-button>
    </div>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    ...
                    Created {{ $fuelRecord->created_at->diffForHumans() }}
                </p>
            </div>
        ...
        <form wire:submit.prevent="update" class="space-y-6">
            ...
            <div class="flex justify-end pt-4 space-x-4">
                ...
                <x-button type="submit" style="submit" icon="fas fa-save" wire:loading.attr="disabled">
                    <span wire:loading.remove wire:target="update">Update Fuel Record</span>
