<header class="h-18 bg-[#1f2431] border-b border-gray-800/50 backdrop-blur-sm shadow-lg" 
    x-data="{ 
    ...
    <div class="h-full flex items-center justify-between px-6 max-w-screen-2xl mx-auto">
        ...
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-3">
                <div class="hidden lg:flex items-center gap-2 px-3 py-1.5 bg-blue-600/10 border border-blue-500/20 rounded-lg">
        ...
        <div class="hidden md:flex flex-1 max-w-2xl mx-8">
            <div class="relative w-full group">
                ...
                <input 
                    type="text" 
                    placeholder="Search shipments, fleet, or users..." 
                ...
                >
                    <kbd class="px-2 py-0.5 text-xs font-semibold text-gray-400 bg-white/5 border border-white/10 rounded">Ctrl</kbd>
                    <kbd class="px-2 py-0.5 text-xs font-semibold text-gray-400 bg-white/5 border border-white/10 rounded">K</kbd>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <!-- Notifications -->
            <button class="relative p-2.5 text-gray-400 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 group">
                ...
                <!-- Notification Badge -->
                <span class="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-500 border-2 border-[#1f2431] rounded-full">
                    3
                </span>
            </button>
            ...
            <div class="relative">
                ...
                >
                    <div class="relative">
                        ...
                        >
                        <span class="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-[#1f2431] rounded-full"></span>
                    </div>
                    <div class="text-left hidden lg:block">
                        <p class="text-sm font-medium text-white group-hover:text-blue-400 transition-colors">{{ auth()->user()->name }}</p>
                ...
                >
                    ...
                    <div class="p-4 bg-gradient-to-br from-blue-600/20 to-purple-600/20 border-b border-white/10">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <span class="inline-flex items-center gap-1 mt-1 px-2 py-0.5 text-xs font-medium text-green-400 bg-green-500/10 border border-green-500/20 rounded-full">
                    ...
                    <!-- Menu Items -->
                    <div class="p-2">
                        <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 group">
                            <div class="w-8 h-8 flex items-center justify-center bg-blue-500/10 text-blue-400 rounded-lg group-hover:bg-blue-500/20 transition-colors">
                        ...
                        <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 group">
                            <div class="w-8 h-8 flex items-center justify-center bg-purple-500/10 text-purple-400 rounded-lg group-hover:bg-purple-500/20 transition-colors">
                        ...
                        <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 group">
                            <div class="w-8 h-8 flex items-center justify-center bg-yellow-500/10 text-yellow-400 rounded-lg group-hover:bg-yellow-500/20 transition-colors">
                    ...
                    <div class="border-t border-white/10 p-2">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-all duration-200 group">
                                <div class="w-8 h-8 flex items-center justify-center bg-red-500/10 text-red-400 rounded-lg group-hover:bg-red-500/20 transition-colors">
