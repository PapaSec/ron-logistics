<aside class="w-64 bg-[#252b3b] dark:bg-[#161a1d] dark:border-gray-800 flex flex-col transition-colors duration-200">
    
    <div class="h-16 flex items-center justify-center bg-[#1f2431] dark:border-gray-800">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        ...
        <div class="px-3 mt-auto pt-4"> 
            ...
            <div class="border-t border-gray-200 dark:border-gray-800 -mx-3 mb-2"></div>
