<aside
    ...
    <div
        class="h-18 flex items-center justify-center bg-[#232838] dark:border-gray-800 transition-all duration-300 overflow-hidden">
        <div class="flex items-center gap-2 px-2">
            <div
                class="w-10 h-10 bg-[#138898] dark:bg-[#138898] rounded-lg flex items-center justify-center transition-all duration-300 flex-shrink-0">
                <i class="fas fa-truck text-white"></i>
            </div>
            <span
                class="sidebar-header-text text-xl font-bold text-white whitespace-nowrap transition-all duration-300 overflow-hidden">
                Ron Logistics
            </span>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto py-4 sidebar-scrollbar transition-all duration-300">
        <div class="space-y-1">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('dashboard') }}" class="group flex items-center gap-3 py-3 text-gray-700 dark:text-gray-500 hover:bg-blue-200 dark:hover:bg-gray-800 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-all duration-200 mx-2
       {{ request()->routeIs('dashboard') ? 'bg-[#138898] dark:bg-[#138898] text-white dark:text-white' : '' }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Overview</span>
                </a>
                ...
                <div x-show="$store.sidebar.collapsed && tooltipVisible"
                    ...
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-3 px-3 py-2 bg-gray-900 dark:bg-gray-800 text-white text-sm font-medium rounded-lg whitespace-nowrap z-50 shadow-xl border border-gray-700/50"
                    style="pointer-events: none;">
                    <span class="block">Overview</span>
                    <!-- Arrow pointing to the icon -->
                    <div
                        class="absolute right-full top-1/2 -translate-y-1/2 w-0 h-0 border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent border-r-[6px] border-r-gray-900 dark:border-r-gray-800">
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Fleet
                        Status</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('live-map') }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Live
                        Map</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('shipments.index') }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">All
                        Shipments</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('shipments.track') }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Track
                        Shipment</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Delayed</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
                    Delayed
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('vehicles.index') }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Vehicle
                        List</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('driver-assignments.index') }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Driver
                        Assignments</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="{{ route('fuel-maintenance.index') }}"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Fuel
                        & Maintenance</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Scheduled
                        Deliveries</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Returns</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
                    Returns
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Cancellations</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
                    Cancellations
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Vendors
                        Directory</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Add
                        Vendor</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Client
                        List</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Invoicing
                        & Billing</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">Reports
                        & Analytics</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
            ...
            <div x-data="{ tooltipVisible: false }" @mouseenter="tooltipVisible = true"
                ...
                <a href="#"
                    ...
                    <span
                        class="sidebar-text font-medium whitespace-nowrap transition-all duration-300 overflow-hidden">User
                        Management</span>
                </a>
                <div x-show="$store.sidebar.collapsed && tooltipVisible" x-transition
                    class="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg">
